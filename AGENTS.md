# HubspotCommunicationPreferences SDK — Agent Guide
...
**Entities** (8): `SubscriptionsActionResponseWithResultsPublicStatus`, `SubscriptionsActionResponseWithResultsPublicWideStatus`, `SubscriptionsActionResponseWithResultsSubscriptionDefinition`, `SubscriptionsBatchResponsePublicBulkOptOutFromAll`, `SubscriptionsBatchResponsePublicStatus`, `SubscriptionsBatchResponsePublicStatusBulk`, `SubscriptionsBatchResponsePublicWideStatusBulk`, `SubscriptionsLinkGeneration`.

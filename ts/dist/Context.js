...
const HubspotCommunicationPreferencesError_1 = require("./HubspotCommunicationPreferencesError");
...
class Context {
    ...
    error(code, msg) {
        return new HubspotCommunicationPreferencesError_1.HubspotCommunicationPreferencesError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,

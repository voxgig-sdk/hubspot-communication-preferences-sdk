...
describe('SubscriptionsBatchResponsePublicStatusBulkEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'subscriptions_batch_response_public_status_bulk.' + op, live)) return
    }
    ...
    assert(null != subscriptions_batch_response_public_status_bulk_ref01_data)
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/subscriptions_batch_response_public_status_bulk/SubscriptionsBatchResponsePublicStatusBulkTestData.json')
  ...
  let idmap = transform(
    ['subscriptions_batch_response_public_status_bulk01','subscriptions_batch_response_public_status_bulk02','subscriptions_batch_response_public_status_bulk03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',

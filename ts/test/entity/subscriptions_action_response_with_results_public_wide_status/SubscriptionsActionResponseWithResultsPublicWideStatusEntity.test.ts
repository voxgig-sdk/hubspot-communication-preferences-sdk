...
describe('SubscriptionsActionResponseWithResultsPublicWideStatusEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'subscriptions_action_response_with_results_public_wide_status.' + op, live)) return
    }
    ...
    let subscriptions_action_response_with_results_public_wide_status_ref01_data = Object.values(setup.data.existing.subscriptions_action_response_with_results_public_wide_status)[0] as any
    ...
    const subscriptions_action_response_with_results_public_wide_status_ref01_match: any = {}
    ...
    const subscriptions_action_response_with_results_public_wide_status_ref01_list = (await subscriptions_action_response_with_results_public_wide_status_ref01_ent.list(subscriptions_action_response_with_results_public_wide_status_ref01_match)).map((e: any) => e.data())

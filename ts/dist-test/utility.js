...
function envOverride(m) {
    if ('TRUE' === process.env.HUBSPOT_COMMUNICATION_PREFERENCES_TEST_LIVE ||
        'TRUE' === process.env.HUBSPOT_COMMUNICATION_PREFERENCES_TEST_OVERRIDE) {
    ...
    m.HUBSPOT_COMMUNICATION_PREFERENCES_TEST_EXPLAIN = process.env.HUBSPOT_COMMUNICATION_PREFERENCES_TEST_EXPLAIN || m.HUBSPOT_COMMUNICATION_PREFERENCES_TEST_EXPLAIN;
    return m;
}

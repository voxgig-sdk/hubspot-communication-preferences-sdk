...
(0, node_test_1.describe)('SubscriptionsActionResponseWithResultsPublicWideStatusEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'subscriptions_action_response_with_results_public_wide_status.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/subscriptions_action_response_with_results_public_wide_status/SubscriptionsActionResponseWithResultsPublicWideStatusTestData.json');
    ...
    let idmap = transform(['subscriptions_action_response_with_results_public_wide_status01', 'subscriptions_action_response_with_results_public_wide_status02', 'subscriptions_action_response_with_results_public_wide_status03', 'status01', 'status02', 'status03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SubscriptionsActionResponseWithResultsPublicWideStatusEntity.test.js.map
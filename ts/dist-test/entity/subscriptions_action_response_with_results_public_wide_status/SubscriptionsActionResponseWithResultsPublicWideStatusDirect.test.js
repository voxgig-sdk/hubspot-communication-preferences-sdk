...
(0, node_test_1.describe)('SubscriptionsActionResponseWithResultsPublicWideStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-subscriptions_action_response_with_results_public_wide_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-subscriptions_action_response_with_results_public_wide_status', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["subscriber_id_string01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_COMMUNICATION_PREFERENCES_TEST_SUBSCRIPTIONS_ACTION_RESPONSE_WITH_RESULTS_PUBLIC_WIDE_STATUS_ENTID'];
...
//# sourceMappingURL=SubscriptionsActionResponseWithResultsPublicWideStatusDirect.test.js.map
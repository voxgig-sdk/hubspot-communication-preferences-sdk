...
(0, node_test_1.describe)('SubscriptionsBatchResponsePublicStatusEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'subscriptions_batch_response_public_status.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != subscriptions_batch_response_public_status_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/subscriptions_batch_response_public_status/SubscriptionsBatchResponsePublicStatusTestData.json');
    ...
    let idmap = transform(['subscriptions_batch_response_public_status01', 'subscriptions_batch_response_public_status02', 'subscriptions_batch_response_public_status03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SubscriptionsBatchResponsePublicStatusEntity.test.js.map
...
(0, node_test_1.describe)('SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'subscriptions_batch_response_public_bulk_opt_out_from_all.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != subscriptions_batch_response_public_bulk_opt_out_from_all_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/subscriptions_batch_response_public_bulk_opt_out_from_all/SubscriptionsBatchResponsePublicBulkOptOutFromAllTestData.json');
    ...
    let idmap = transform(['subscriptions_batch_response_public_bulk_opt_out_from_all01', 'subscriptions_batch_response_public_bulk_opt_out_from_all02', 'subscriptions_batch_response_public_bulk_opt_out_from_all03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity.test.js.map
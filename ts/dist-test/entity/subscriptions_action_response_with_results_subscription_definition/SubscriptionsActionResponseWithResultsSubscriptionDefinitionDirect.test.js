...
(0, node_test_1.describe)('SubscriptionsActionResponseWithResultsSubscriptionDefinitionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HubspotCommunicationPreferencesSDK({
    ...
    (0, node_test_1.test)('direct-list-subscriptions_action_response_with_results_subscription_definition', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-subscriptions_action_response_with_results_subscription_definition', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.HUBSPOT_COMMUNICATION_PREFERENCES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HubspotCommunicationPreferencesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.HUBSPOT_COMMUNICATION_PREFERENCES_APIKEY,
        }));
        let idmap = env['HUBSPOT_COMMUNICATION_PREFERENCES_TEST_SUBSCRIPTIONS_ACTION_RESPONSE_WITH_RESULTS_SUBSCRIPTION_DEFINITION_ENTID'];
    ...
    const client = new __1.HubspotCommunicationPreferencesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SubscriptionsActionResponseWithResultsSubscriptionDefinitionDirect.test.js.map
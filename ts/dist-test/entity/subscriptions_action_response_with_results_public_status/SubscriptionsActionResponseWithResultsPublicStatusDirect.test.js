...
(0, node_test_1.describe)('SubscriptionsActionResponseWithResultsPublicStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-subscriptions_action_response_with_results_public_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-subscriptions_action_response_with_results_public_status', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_COMMUNICATION_PREFERENCES_TEST_SUBSCRIPTIONS_ACTION_RESPONSE_WITH_RESULTS_PUBLIC_STATUS_ENTID'];
...
//# sourceMappingURL=SubscriptionsActionResponseWithResultsPublicStatusDirect.test.js.map
...
(0, node_test_1.describe)('exists', async () => {
    ...
    (0, node_test_1.test)('test-mode', () => {
        ...
        (0, node_assert_1.equal)(testsdk instanceof __1.HubspotCommunicationPreferencesSDK, true, 'HubspotCommunicationPreferencesSDK.test() must return a client synchronously');
    });
});

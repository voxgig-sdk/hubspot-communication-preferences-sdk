...
class HubspotCommunicationPreferencesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HubspotCommunicationPreferencesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = HubspotCommunicationPreferencesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = HubspotCommunicationPreferencesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

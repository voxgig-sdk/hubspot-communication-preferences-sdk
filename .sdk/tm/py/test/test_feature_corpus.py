# HubspotCommunicationPreferences SDK feature corpus test
#
...
def _client(kase):
    ...
    HubspotCommunicationPreferencesSDK(...), not HubspotCommunicationPreferencesSDK.test(...): the `test` feature is
    ...
    return HubspotCommunicationPreferencesSDK(opts)

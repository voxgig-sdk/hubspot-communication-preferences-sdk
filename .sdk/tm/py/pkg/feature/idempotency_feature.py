# HubspotCommunicationPreferences SDK idempotency feature
...
# deterministic tests.
class HubspotCommunicationPreferencesIdempotencyFeature(HubspotCommunicationPreferencesBaseFeature):
    def __init__(self):
        super().__init__()
        self.version = "0.0.1"

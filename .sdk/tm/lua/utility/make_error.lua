...
local function make_error_util(ctx, err)
  ...
  local msg = "HubspotCommunicationPreferencesSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = HubspotCommunicationPreferencesError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == HubspotCommunicationPreferencesError then

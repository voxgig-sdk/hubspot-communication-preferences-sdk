...
describe('exists', async () => {
  ...
  //
  // HubspotCommunicationPreferencesSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof HubspotCommunicationPreferencesSDK, true,
      'HubspotCommunicationPreferencesSDK.test() must return a client synchronously')
  })

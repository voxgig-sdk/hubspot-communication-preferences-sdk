...
class HubspotCommunicationPreferencesIdempotencyFeature extends HubspotCommunicationPreferencesBaseFeature
{
    ...
    private function _mutating(HubspotCommunicationPreferencesContext $ctx): bool
    {

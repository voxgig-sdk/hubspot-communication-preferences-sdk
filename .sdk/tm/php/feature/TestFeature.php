...
// HubspotCommunicationPreferences SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class HubspotCommunicationPreferencesTestFeature extends HubspotCommunicationPreferencesBaseFeature
{
    ...
    public function init(HubspotCommunicationPreferencesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (HubspotCommunicationPreferencesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = HubspotCommunicationPreferencesParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (HubspotCommunicationPreferencesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(HubspotCommunicationPreferencesContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = HubspotCommunicationPreferencesParam::call($ctx, $k);

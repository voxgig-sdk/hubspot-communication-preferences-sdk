...
// HubspotCommunicationPreferences SDK utility: make_options

class HubspotCommunicationPreferencesMakeOptions
{
    ...
    public static function call(HubspotCommunicationPreferencesContext $ctx): array
    {
        ...
        //
        // `HubspotCommunicationPreferencesSchema::optspec()` is built from the model:
        ...
        $optspec = HubspotCommunicationPreferencesSchema::optspec();

...
// HubspotCommunicationPreferences SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = HubspotCommunicationPreferencesOmni::makeStructRunner(
    ...
    {
        return HubspotCommunicationPreferencesOmni::objmodel(HubspotCommunicationPreferencesOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return HubspotCommunicationPreferencesOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return HubspotCommunicationPreferencesOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(HubspotCommunicationPreferencesOmni::structfix($now, Struct::undef()))
                        !== json_encode(HubspotCommunicationPreferencesOmni::structfix($val, Struct::undef()))) {

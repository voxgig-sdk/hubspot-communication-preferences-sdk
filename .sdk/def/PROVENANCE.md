...
## hubspot-communication-preferences-openapi.json

- **Source:** https://github.com/HubSpot/HubSpot-public-api-spec-collection
  (`PublicApiSpecs/Communication Preferences/*/Rollouts/*/<version>/*.json`)
- **Publisher:** HubSpot (the official HubSpot-maintained spec collection)
- **Retrieved:** 2026-09-17
- **Format:** OpenAPI 3.0.1
- **Size:** 59148 bytes
- **Coverage:** every API HubSpot publishes under **Communication Preferences** — 1 document(s),
  merged to 8 paths and 25 component schemas.

## Why this is a merge, and one SDK per product group

HubSpot publishes **140** separate OpenAPI documents, one per API, grouped by
product (Communication Preferences is one such group). One SDK per document would be 140 SDKs;

...
|---|---|---|
| `js/` | @voxgig-sdk/hubspot-communication-preferences-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/hubspot-communication-preferences | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hubspot-communication-preferences-js \
      --repository voxgig-sdk/hubspot-communication-preferences-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hubspot-communication-preferences-js` shows it, and
`npm trust revoke @voxgig-sdk/hubspot-communication-preferences-js --id=<id>` removes it.

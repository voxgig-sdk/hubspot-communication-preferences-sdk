# HubspotCommunicationPreferences SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HubspotCommunicationPreferencesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HubspotCommunicationPreferencesSDK(...) and HubspotCommunicationPreferencesSDK.test(...) become
#      HubspotCommunicationPreferencesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hubspotcommunicationpreferences_sdk"
_SDK_CLASS = "HubspotCommunicationPreferencesSDK"
...
_ENTITIES = {
    "SubscriptionsActionResponseWithResultsPublicStatus": "subscriptions_action_response_with_results_public_status",
    "SubscriptionsActionResponseWithResultsPublicWideStatus": "subscriptions_action_response_with_results_public_wide_status",
    "SubscriptionsActionResponseWithResultsSubscriptionDefinition": "subscriptions_action_response_with_results_subscription_definition",
    "SubscriptionsBatchResponsePublicBulkOptOutFromAll": "subscriptions_batch_response_public_bulk_opt_out_from_all",
    "SubscriptionsBatchResponsePublicStatus": "subscriptions_batch_response_public_status",
    "SubscriptionsBatchResponsePublicStatusBulk": "subscriptions_batch_response_public_status_bulk",
    "SubscriptionsBatchResponsePublicWideStatusBulk": "subscriptions_batch_response_public_wide_status_bulk",
    "SubscriptionsLinkGeneration": "subscriptions_link_generation",
}

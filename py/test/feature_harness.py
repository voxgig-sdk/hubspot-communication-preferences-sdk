# HubspotCommunicationPreferences SDK feature test harness
#
...
from hubspotcommunicationpreferences_sdk.features import _make_feature
...
class _Ctx:
    ...
    def __init__(self, client, utility, op=None, entity=None, ctrl=None):
        ...
        self.out = {}
        self.ctrl = ctrl if ctrl is not None else HubspotCommunicationPreferencesControl()
        self.meta = {}
        self.op = op
        self.entity = entity
...
class Harness:
    ...
    def _populate_result(self, ctx, response, fetch_err):
        result = HubspotCommunicationPreferencesResult({})
        ctx.result = result
    ...
    def op(self, op="load", entity="widget", method=None, path=None,
        ...
        ctx = _Ctx(self.client, self.utility,
                   ...
                   ctrl=HubspotCommunicationPreferencesControl(ctrl or {}))
        ...
        try:
            ...
            if spec is None:
                ...
                for key, val in (headers or {}).items():
                    merged[key] = val
                spec = HubspotCommunicationPreferencesSpec({
                    "method": method,
                    "base": self.base,

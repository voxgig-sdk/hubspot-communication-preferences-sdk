...
class SubscriptionsBatchResponsePublicWideStatusBulkEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubscriptionsBatchResponsePublicWideStatusBulkEntity(self._client, opts)
    ...
    def data_get(self) -> SubscriptionsBatchResponsePublicWideStatusBulk:
    ...
    def match_get(self) -> SubscriptionsBatchResponsePublicWideStatusBulk:
    ...
    def create(self, reqdata: SubscriptionsBatchResponsePublicWideStatusBulkCreateData, ctrl=None) -> SubscriptionsBatchResponsePublicWideStatusBulk:
        utility = self._utility

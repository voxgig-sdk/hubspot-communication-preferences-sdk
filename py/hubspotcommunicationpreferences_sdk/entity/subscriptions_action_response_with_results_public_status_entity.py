...
from hubspotcommunicationpreferences_sdk.hubspotcommunicationpreferences_types import (
...
class SubscriptionsActionResponseWithResultsPublicStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubscriptionsActionResponseWithResultsPublicStatusEntity(self._client, opts)
    ...
    def data_get(self) -> SubscriptionsActionResponseWithResultsPublicStatus:
    ...
    def match_get(self) -> SubscriptionsActionResponseWithResultsPublicStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> SubscriptionsActionResponseWithResultsPublicStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.SubscriptionsActionResponseWithResultsPublicStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: SubscriptionsActionResponseWithResultsPublicStatusCreateData, ctrl=None) -> SubscriptionsActionResponseWithResultsPublicStatus:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,

...
class SubscriptionsBatchResponsePublicStatusBulkEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubscriptionsBatchResponsePublicStatusBulkEntity(self._client, opts)
    ...
    def data_get(self) -> SubscriptionsBatchResponsePublicStatusBulk:
    ...
    def match_get(self) -> SubscriptionsBatchResponsePublicStatusBulk:
    ...
    def create(self, reqdata: SubscriptionsBatchResponsePublicStatusBulkCreateData, ctrl=None) -> SubscriptionsBatchResponsePublicStatusBulk:
        utility = self._utility

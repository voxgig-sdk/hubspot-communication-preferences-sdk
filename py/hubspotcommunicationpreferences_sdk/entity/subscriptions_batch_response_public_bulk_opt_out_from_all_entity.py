...
class SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity(self._client, opts)
    ...
    def data_get(self) -> SubscriptionsBatchResponsePublicBulkOptOutFromAll:
    ...
    def match_get(self) -> SubscriptionsBatchResponsePublicBulkOptOutFromAll:
    ...
    def create(self, reqdata: SubscriptionsBatchResponsePublicBulkOptOutFromAllCreateData, ctrl=None) -> SubscriptionsBatchResponsePublicBulkOptOutFromAll:
        utility = self._utility

...
class SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity(self._client, opts)
    ...
    def data_get(self) -> SubscriptionsActionResponseWithResultsSubscriptionDefinition:
    ...
    def match_get(self) -> SubscriptionsActionResponseWithResultsSubscriptionDefinition:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SubscriptionsActionResponseWithResultsSubscriptionDefinition]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SubscriptionsActionResponseWithResultsSubscriptionDefinition().list() works with no args.
        if reqmatch is None:
            reqmatch = {}

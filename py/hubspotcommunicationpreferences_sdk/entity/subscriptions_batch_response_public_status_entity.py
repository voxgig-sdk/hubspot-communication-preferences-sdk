...
class SubscriptionsBatchResponsePublicStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubscriptionsBatchResponsePublicStatusEntity(self._client, opts)
    ...
    def data_get(self) -> SubscriptionsBatchResponsePublicStatus:
    ...
    def match_get(self) -> SubscriptionsBatchResponsePublicStatus:
    ...
    def create(self, reqdata: SubscriptionsBatchResponsePublicStatusCreateData, ctrl=None) -> SubscriptionsBatchResponsePublicStatus:
        utility = self._utility

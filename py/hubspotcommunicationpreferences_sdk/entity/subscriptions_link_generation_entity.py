...
class SubscriptionsLinkGenerationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubscriptionsLinkGenerationEntity(self._client, opts)
    ...
    def data_get(self) -> SubscriptionsLinkGeneration:
    ...
    def match_get(self) -> SubscriptionsLinkGeneration:
    ...
    def create(self, reqdata: SubscriptionsLinkGenerationCreateData, ctrl=None) -> SubscriptionsLinkGeneration:
        utility = self._utility

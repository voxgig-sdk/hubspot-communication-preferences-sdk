...
class SubscriptionsActionResponseWithResultsPublicWideStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubscriptionsActionResponseWithResultsPublicWideStatusEntity(self._client, opts)
    ...
    def data_get(self) -> SubscriptionsActionResponseWithResultsPublicWideStatus:
    ...
    def match_get(self) -> SubscriptionsActionResponseWithResultsPublicWideStatus:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SubscriptionsActionResponseWithResultsPublicWideStatus]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SubscriptionsActionResponseWithResultsPublicWideStatus().list() works with no args.
        if reqmatch is None:
            reqmatch = {}

...
from hubspotcommunicationpreferences_sdk.core.control import HubspotCommunicationPreferencesControl
...
from hubspotcommunicationpreferences_sdk.core.helpers import get_ctx_prop, to_map
...
class HubspotCommunicationPreferencesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = HubspotCommunicationPreferencesControl()
        ...
        if isinstance(sp, HubspotCommunicationPreferencesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HubspotCommunicationPreferencesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HubspotCommunicationPreferencesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return HubspotCommunicationPreferencesOperation({})
        ...
        op = HubspotCommunicationPreferencesOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return HubspotCommunicationPreferencesError(code, msg, self)

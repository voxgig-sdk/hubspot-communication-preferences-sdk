// Command HubspotCommunicationPreferences-mcp is an MCP server exposing the HubspotCommunicationPreferences
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HubspotCommunicationPreferences_list  — list records of an entity
//	HubspotCommunicationPreferences_load  — load a single record of an entity
//

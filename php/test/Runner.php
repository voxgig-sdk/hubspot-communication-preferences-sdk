...
class HubspotCommunicationPreferencesTestRunner
{
    ...
    {
        $live = self::getenv('HUBSPOT_COMMUNICATION_PREFERENCES_TEST_LIVE');
        $override = self::getenv('HUBSPOT_COMMUNICATION_PREFERENCES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('HUBSPOT_COMMUNICATION_PREFERENCES_TEST_EXPLAIN');
...
class_alias('HubspotCommunicationPreferencesTestRunner', 'Runner');
class_alias('HubspotCommunicationPreferencesHelpers', 'Helpers');

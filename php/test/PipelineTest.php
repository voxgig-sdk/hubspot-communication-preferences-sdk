...
// HubspotCommunicationPreferences SDK pipeline test
//
...
{
    private static function utility(): HubspotCommunicationPreferencesUtility
    {
        return new HubspotCommunicationPreferencesUtility();
    }
    ...
    private static function ctx(array $over = []): HubspotCommunicationPreferencesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HubspotCommunicationPreferencesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HubspotCommunicationPreferencesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HubspotCommunicationPreferencesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HubspotCommunicationPreferencesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HubspotCommunicationPreferencesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HubspotCommunicationPreferencesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HubspotCommunicationPreferencesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HubspotCommunicationPreferencesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HubspotCommunicationPreferencesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HubspotCommunicationPreferencesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HubspotCommunicationPreferencesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HubspotCommunicationPreferencesResponse([]),
            'result' => new HubspotCommunicationPreferencesResult([]),
        ]);
        [, $err] = HubspotCommunicationPreferencesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HubspotCommunicationPreferencesSpec([]),
            'response' => null,
            'result' => new HubspotCommunicationPreferencesResult([]),
        ]);
        [, $err] = HubspotCommunicationPreferencesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HubspotCommunicationPreferencesSpec(['step' => 's']),
            'response' => new HubspotCommunicationPreferencesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HubspotCommunicationPreferencesResult([]),
        ]);
        [, $err] = HubspotCommunicationPreferencesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HubspotCommunicationPreferencesSpec(['step' => 's']),
            'response' => new HubspotCommunicationPreferencesResponse(self::resp(200, ['v' => 1])),
            'result' => new HubspotCommunicationPreferencesResult([]),
        ]);
        [, $err] = HubspotCommunicationPreferencesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HubspotCommunicationPreferencesSpec(['step' => 's']),
            'response' => new HubspotCommunicationPreferencesResponse(self::resp(200, ['v' => 2])),
            'result' => new HubspotCommunicationPreferencesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HubspotCommunicationPreferencesMakeResponse::call($ctx);
    ...
    {
        $preset = new HubspotCommunicationPreferencesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HubspotCommunicationPreferencesSpec([]),
            'response' => new HubspotCommunicationPreferencesResponse([]),
            'result' => new HubspotCommunicationPreferencesResult([]),
        ...
        [$got, $err] = HubspotCommunicationPreferencesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HubspotCommunicationPreferencesResult([])]);
        [, $err] = HubspotCommunicationPreferencesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HubspotCommunicationPreferencesSpec([]), 'result' => null]);
        [, $err] = HubspotCommunicationPreferencesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HubspotCommunicationPreferencesSpec(['step' => 's']),
            'result' => new HubspotCommunicationPreferencesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HubspotCommunicationPreferencesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HubspotCommunicationPreferencesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HubspotCommunicationPreferencesSpec(['step' => 's']),
            'result' => new HubspotCommunicationPreferencesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HubspotCommunicationPreferencesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HubspotCommunicationPreferencesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HubspotCommunicationPreferencesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HubspotCommunicationPreferencesSpec([]),
            'result' => new HubspotCommunicationPreferencesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HubspotCommunicationPreferencesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HubspotCommunicationPreferencesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HubspotCommunicationPreferencesError('boom', 'boom');
        $utility->fetcher = function (HubspotCommunicationPreferencesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HubspotCommunicationPreferencesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HubspotCommunicationPreferencesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HubspotCommunicationPreferencesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HubspotCommunicationPreferencesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HubspotCommunicationPreferencesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HubspotCommunicationPreferencesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HubspotCommunicationPreferencesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HubspotCommunicationPreferencesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HubspotCommunicationPreferencesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HubspotCommunicationPreferencesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HubspotCommunicationPreferencesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HubspotCommunicationPreferencesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HubspotCommunicationPreferencesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HubspotCommunicationPreferencesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HubspotCommunicationPreferencesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HubspotCommunicationPreferencesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HubspotCommunicationPreferencesResult(['ok' => false])]);
        $this->expectException(HubspotCommunicationPreferencesError::class);
        HubspotCommunicationPreferencesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HubspotCommunicationPreferencesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HubspotCommunicationPreferencesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HubspotCommunicationPreferencesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HubspotCommunicationPreferencesBaseFeature();
        $b = new HubspotCommunicationPreferencesBaseFeature();
        HubspotCommunicationPreferencesFeatureAdd::call($ctx, $a);
        HubspotCommunicationPreferencesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HubspotCommunicationPreferencesBaseFeature
    {
        $f = new HubspotCommunicationPreferencesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HubspotCommunicationPreferencesFeatureAdd::call($ctx, self::named_feature('a'));
        HubspotCommunicationPreferencesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        HubspotCommunicationPreferencesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        HubspotCommunicationPreferencesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        HubspotCommunicationPreferencesFeatureAdd::call($ctx, $replace);
        ...
        HubspotCommunicationPreferencesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HubspotCommunicationPreferencesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HubspotCommunicationPreferencesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HubspotCommunicationPreferencesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HubspotCommunicationPreferencesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HubspotCommunicationPreferencesResponse(['headers' => null]),
            'result' => new HubspotCommunicationPreferencesResult([]),
        ]);
        HubspotCommunicationPreferencesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HubspotCommunicationPreferencesResultBody::call($ctx);

...
// HubspotCommunicationPreferences SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HubspotCommunicationPreferencesSDK::test)
...
{
    private const SDK_CLASS = 'HubspotCommunicationPreferencesSDK';
    ...
    private const SDK_BASE = 'hubspotcommunicationpreferences_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../hubspotcommunicationpreferences_sdk.php';

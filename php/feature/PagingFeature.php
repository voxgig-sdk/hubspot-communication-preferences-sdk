...
// HubspotCommunicationPreferences SDK paging feature
...
class HubspotCommunicationPreferencesPagingFeature extends HubspotCommunicationPreferencesBaseFeature
{
    ...
    private function _graphql_pre_request(HubspotCommunicationPreferencesContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(HubspotCommunicationPreferencesContext $ctx): bool
    {

...
// HubspotCommunicationPreferences SDK ratelimit feature
...
class HubspotCommunicationPreferencesRatelimitFeature extends HubspotCommunicationPreferencesBaseFeature
{
    ...
    private function _acquire(HubspotCommunicationPreferencesContext $ctx): void
    {
    ...
    private function _track(HubspotCommunicationPreferencesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

...
// HubspotCommunicationPreferences SDK timeout feature
...
class HubspotCommunicationPreferencesTimeoutFeature extends HubspotCommunicationPreferencesBaseFeature
{
    ...
    private function _with_timeout(HubspotCommunicationPreferencesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HubspotCommunicationPreferencesContext $_ctx, float $ms): void
    {
        $client = $this->client;

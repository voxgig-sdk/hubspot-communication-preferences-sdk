...
class HubspotCommunicationPreferencesDebugFeature extends HubspotCommunicationPreferencesBaseFeature
{
    ...
    private function _finish(HubspotCommunicationPreferencesContext $ctx, bool $ok): void
    {

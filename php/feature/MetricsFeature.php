...
class HubspotCommunicationPreferencesMetricsFeature extends HubspotCommunicationPreferencesBaseFeature
{
    ...
    private function _record(HubspotCommunicationPreferencesContext $ctx, bool $ok): void
    {

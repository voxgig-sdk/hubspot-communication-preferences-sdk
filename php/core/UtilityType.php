...
// HubspotCommunicationPreferences SDK utility type

class HubspotCommunicationPreferencesUtility
{
    ...
    public static function copy(HubspotCommunicationPreferencesUtility $src): HubspotCommunicationPreferencesUtility
    {
        $u = new HubspotCommunicationPreferencesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

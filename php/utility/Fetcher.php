...
// HubspotCommunicationPreferences SDK utility: fetcher

class HubspotCommunicationPreferencesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HubspotCommunicationPreferencesSDK/1.0)';
    ...
    public static function call(HubspotCommunicationPreferencesContext $ctx, string $fullurl, array $fetchdef): array
    {

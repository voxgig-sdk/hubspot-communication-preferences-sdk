...
// HubspotCommunicationPreferences SDK utility: graphql
//
...
class HubspotCommunicationPreferencesGraphql
{
    ...
    // equivalent.
    public static function body(HubspotCommunicationPreferencesContext $ctx): mixed
    {
    ...
    public static function errors(HubspotCommunicationPreferencesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

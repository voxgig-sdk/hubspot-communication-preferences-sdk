...
class SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscriptions_batch_response_public_bulk_opt_out_from_all";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionsBatchResponsePublicBulkOptOutFromAll|array $args SubscriptionsBatchResponsePublicBulkOptOutFromAll data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionsBatchResponsePublicBulkOptOutFromAll|array The current SubscriptionsBatchResponsePublicBulkOptOutFromAll data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionsBatchResponsePublicBulkOptOutFromAll fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionsBatchResponsePublicBulkOptOutFromAll fields).
     */
    ...
    /**
     * Create a new SubscriptionsBatchResponsePublicBulkOptOutFromAll.
     *
     * @param SubscriptionsBatchResponsePublicBulkOptOutFromAllCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SubscriptionsBatchResponsePublicBulkOptOutFromAllCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionsBatchResponsePublicBulkOptOutFromAll|array The created SubscriptionsBatchResponsePublicBulkOptOutFromAll as an assoc-array at the

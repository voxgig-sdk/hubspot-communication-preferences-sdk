...
// HubspotCommunicationPreferences SDK SubscriptionsLinkGeneration entity
...
class SubscriptionsLinkGenerationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscriptions_link_generation";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionsLinkGenerationEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionsLinkGeneration|array $args SubscriptionsLinkGeneration data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionsLinkGeneration|array The current SubscriptionsLinkGeneration data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionsLinkGeneration fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionsLinkGeneration fields).
     */
    ...
    /**
     * Create a new SubscriptionsLinkGeneration.
     *
     * @param SubscriptionsLinkGenerationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SubscriptionsLinkGenerationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionsLinkGeneration|array The created SubscriptionsLinkGeneration as an assoc-array at the

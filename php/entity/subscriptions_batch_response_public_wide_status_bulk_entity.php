...
class SubscriptionsBatchResponsePublicWideStatusBulkEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscriptions_batch_response_public_wide_status_bulk";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionsBatchResponsePublicWideStatusBulkEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionsBatchResponsePublicWideStatusBulk|array $args SubscriptionsBatchResponsePublicWideStatusBulk data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionsBatchResponsePublicWideStatusBulk|array The current SubscriptionsBatchResponsePublicWideStatusBulk data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionsBatchResponsePublicWideStatusBulk fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionsBatchResponsePublicWideStatusBulk fields).
     */
    ...
    /**
     * Create a new SubscriptionsBatchResponsePublicWideStatusBulk.
     *
     * @param SubscriptionsBatchResponsePublicWideStatusBulkCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SubscriptionsBatchResponsePublicWideStatusBulkCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionsBatchResponsePublicWideStatusBulk|array The created SubscriptionsBatchResponsePublicWideStatusBulk as an assoc-array at the

...
class SubscriptionsBatchResponsePublicStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscriptions_batch_response_public_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionsBatchResponsePublicStatusEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionsBatchResponsePublicStatus|array $args SubscriptionsBatchResponsePublicStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionsBatchResponsePublicStatus|array The current SubscriptionsBatchResponsePublicStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionsBatchResponsePublicStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionsBatchResponsePublicStatus fields).
     */
    ...
    /**
     * Create a new SubscriptionsBatchResponsePublicStatus.
     *
     * @param SubscriptionsBatchResponsePublicStatusCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SubscriptionsBatchResponsePublicStatusCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionsBatchResponsePublicStatus|array The created SubscriptionsBatchResponsePublicStatus as an assoc-array at the

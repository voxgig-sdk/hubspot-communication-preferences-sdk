...
class SubscriptionsActionResponseWithResultsPublicWideStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscriptions_action_response_with_results_public_wide_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionsActionResponseWithResultsPublicWideStatusEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionsActionResponseWithResultsPublicWideStatus|array $args SubscriptionsActionResponseWithResultsPublicWideStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionsActionResponseWithResultsPublicWideStatus|array The current SubscriptionsActionResponseWithResultsPublicWideStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionsActionResponseWithResultsPublicWideStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionsActionResponseWithResultsPublicWideStatus fields).
     */
    ...
    /**
     * List SubscriptionsActionResponseWithResultsPublicWideStatus items matching the given filter.
     *
     * @param SubscriptionsActionResponseWithResultsPublicWideStatusListMatch|array|null $reqmatch Match filter (any subset
     *   of SubscriptionsActionResponseWithResultsPublicWideStatus fields) as an assoc-array; SubscriptionsActionResponseWithResultsPublicWideStatusListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionsActionResponseWithResultsPublicWideStatus[]|array A list of SubscriptionsActionResponseWithResultsPublicWideStatus items as assoc-arrays at

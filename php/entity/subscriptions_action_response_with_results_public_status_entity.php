...
// HubspotCommunicationPreferences SDK SubscriptionsActionResponseWithResultsPublicStatus entity
...
class SubscriptionsActionResponseWithResultsPublicStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscriptions_action_response_with_results_public_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionsActionResponseWithResultsPublicStatusEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionsActionResponseWithResultsPublicStatus|array $args SubscriptionsActionResponseWithResultsPublicStatus data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = HubspotCommunicationPreferencesHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return SubscriptionsActionResponseWithResultsPublicStatus|array The current SubscriptionsActionResponseWithResultsPublicStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionsActionResponseWithResultsPublicStatus fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = HubspotCommunicationPreferencesHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of SubscriptionsActionResponseWithResultsPublicStatus fields).
     */
    ...
    /**
     * Load a single SubscriptionsActionResponseWithResultsPublicStatus.
     *
     * @param SubscriptionsActionResponseWithResultsPublicStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SubscriptionsActionResponseWithResultsPublicStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionsActionResponseWithResultsPublicStatus|array The loaded SubscriptionsActionResponseWithResultsPublicStatus as an assoc-array at the
     *   SDK boundary; throws HubspotCommunicationPreferencesError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = HubspotCommunicationPreferencesHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * Create a new SubscriptionsActionResponseWithResultsPublicStatus.
     *
     * @param SubscriptionsActionResponseWithResultsPublicStatusCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SubscriptionsActionResponseWithResultsPublicStatusCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionsActionResponseWithResultsPublicStatus|array The created SubscriptionsActionResponseWithResultsPublicStatus as an assoc-array at the
     *   SDK boundary; throws HubspotCommunicationPreferencesError on failure (item-5 convention).
     */

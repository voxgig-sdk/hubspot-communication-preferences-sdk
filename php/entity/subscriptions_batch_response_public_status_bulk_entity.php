...
class SubscriptionsBatchResponsePublicStatusBulkEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscriptions_batch_response_public_status_bulk";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionsBatchResponsePublicStatusBulkEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionsBatchResponsePublicStatusBulk|array $args SubscriptionsBatchResponsePublicStatusBulk data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionsBatchResponsePublicStatusBulk|array The current SubscriptionsBatchResponsePublicStatusBulk data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionsBatchResponsePublicStatusBulk fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionsBatchResponsePublicStatusBulk fields).
     */
    ...
    /**
     * Create a new SubscriptionsBatchResponsePublicStatusBulk.
     *
     * @param SubscriptionsBatchResponsePublicStatusBulkCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SubscriptionsBatchResponsePublicStatusBulkCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionsBatchResponsePublicStatusBulk|array The created SubscriptionsBatchResponsePublicStatusBulk as an assoc-array at the

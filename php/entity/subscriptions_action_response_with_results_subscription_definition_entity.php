...
class SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscriptions_action_response_with_results_subscription_definition";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionsActionResponseWithResultsSubscriptionDefinition|array $args SubscriptionsActionResponseWithResultsSubscriptionDefinition data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionsActionResponseWithResultsSubscriptionDefinition|array The current SubscriptionsActionResponseWithResultsSubscriptionDefinition data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionsActionResponseWithResultsSubscriptionDefinition fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionsActionResponseWithResultsSubscriptionDefinition fields).
     */
    ...
    /**
     * List SubscriptionsActionResponseWithResultsSubscriptionDefinition items matching the given filter.
     *
     * @param SubscriptionsActionResponseWithResultsSubscriptionDefinitionListMatch|array|null $reqmatch Match filter (any subset
     *   of SubscriptionsActionResponseWithResultsSubscriptionDefinition fields) as an assoc-array; SubscriptionsActionResponseWithResultsSubscriptionDefinitionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionsActionResponseWithResultsSubscriptionDefinition[]|array A list of SubscriptionsActionResponseWithResultsSubscriptionDefinition items as assoc-arrays at
     *   the SDK boundary; throws HubspotCommunicationPreferencesError on failure (item-5 convention).
     */

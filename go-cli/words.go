...
func registerSDKWords(r *eng.Registry, client *sdk.HubspotCommunicationPreferencesSDK) {
...
func runOp(client *sdk.HubspotCommunicationPreferencesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

...
const testSeed = `map[string]any{"entity": map[string]any{"subscriptions_action_response_with_results_public_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscriptions_action_response_with_results_public_wide_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscriptions_action_response_with_results_subscription_definition": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscriptions_batch_response_public_bulk_opt_out_from_all": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscriptions_batch_response_public_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscriptions_batch_response_public_status_bulk": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscriptions_batch_response_public_wide_status_bulk": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscriptions_link_generation": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

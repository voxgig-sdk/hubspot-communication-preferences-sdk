...
describe("SubscriptionsActionResponseWithResultsPublicStatusDirect", function()
  it("should direct-load-subscriptions_action_response_with_results_public_status", function()
    local setup = subscriptions_action_response_with_results_public_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-subscriptions_action_response_with_results_public_status", setup.live and "live" or "unit")

...
function runner.env_override(m)
  local live = runner.getenv("HUBSPOT_COMMUNICATION_PREFERENCES_TEST_LIVE")
  local override = runner.getenv("HUBSPOT_COMMUNICATION_PREFERENCES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HUBSPOT_COMMUNICATION_PREFERENCES_TEST_EXPLAIN")

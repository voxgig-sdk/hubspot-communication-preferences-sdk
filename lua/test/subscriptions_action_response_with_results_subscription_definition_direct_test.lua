...
describe("SubscriptionsActionResponseWithResultsSubscriptionDefinitionDirect", function()
  it("should direct-list-subscriptions_action_response_with_results_subscription_definition", function()
    local setup = subscriptions_action_response_with_results_subscription_definition_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-subscriptions_action_response_with_results_subscription_definition", setup.live and "live" or "unit")

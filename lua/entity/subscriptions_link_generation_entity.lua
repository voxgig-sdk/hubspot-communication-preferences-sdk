...
local SubscriptionsLinkGenerationEntity = {}
SubscriptionsLinkGenerationEntity.__index = SubscriptionsLinkGenerationEntity


function SubscriptionsLinkGenerationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionsLinkGenerationEntity)
  self._name = "subscriptions_link_generation"
  self._client = client
...
function SubscriptionsLinkGenerationEntity:get_name()
  return self._name
end


function SubscriptionsLinkGenerationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionsLinkGenerationEntity.new(self._client, opts)
end
...
function SubscriptionsLinkGenerationEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionsLinkGenerationEntity:deleted()
  return true == self._deleted
end


function SubscriptionsLinkGenerationEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionsLinkGenerationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionsLinkGenerationEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionsLinkGenerationEntity:match_get()
...
function SubscriptionsLinkGenerationEntity:stream(action, args, callopts)
...
---@param reqdata SubscriptionsLinkGenerationCreateData
---@param ctrl? table
---@return SubscriptionsLinkGeneration
---@return string? err
function SubscriptionsLinkGenerationEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function SubscriptionsLinkGenerationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionsLinkGenerationEntity

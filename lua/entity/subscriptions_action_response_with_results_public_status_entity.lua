...
local SubscriptionsActionResponseWithResultsPublicStatusEntity = {}
SubscriptionsActionResponseWithResultsPublicStatusEntity.__index = SubscriptionsActionResponseWithResultsPublicStatusEntity


function SubscriptionsActionResponseWithResultsPublicStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionsActionResponseWithResultsPublicStatusEntity)
  self._name = "subscriptions_action_response_with_results_public_status"
  self._client = client
...
function SubscriptionsActionResponseWithResultsPublicStatusEntity:get_name()
  return self._name
end


function SubscriptionsActionResponseWithResultsPublicStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionsActionResponseWithResultsPublicStatusEntity.new(self._client, opts)
end
...
function SubscriptionsActionResponseWithResultsPublicStatusEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionsActionResponseWithResultsPublicStatusEntity:deleted()
  return true == self._deleted
end


function SubscriptionsActionResponseWithResultsPublicStatusEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionsActionResponseWithResultsPublicStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionsActionResponseWithResultsPublicStatusEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionsActionResponseWithResultsPublicStatusEntity:match_get()
...
function SubscriptionsActionResponseWithResultsPublicStatusEntity:stream(action, args, callopts)
...
---@param reqmatch SubscriptionsActionResponseWithResultsPublicStatusLoadMatch
---@param ctrl? table
---@return SubscriptionsActionResponseWithResultsPublicStatus
---@return string? err
function SubscriptionsActionResponseWithResultsPublicStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata SubscriptionsActionResponseWithResultsPublicStatusCreateData
---@param ctrl? table
---@return SubscriptionsActionResponseWithResultsPublicStatus
---@return string? err
function SubscriptionsActionResponseWithResultsPublicStatusEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function SubscriptionsActionResponseWithResultsPublicStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionsActionResponseWithResultsPublicStatusEntity

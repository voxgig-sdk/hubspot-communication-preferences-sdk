-- HubspotCommunicationPreferences SDK SubscriptionsBatchResponsePublicStatus entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SubscriptionsBatchResponsePublicStatusEntity = {}
SubscriptionsBatchResponsePublicStatusEntity.__index = SubscriptionsBatchResponsePublicStatusEntity


function SubscriptionsBatchResponsePublicStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionsBatchResponsePublicStatusEntity)
  self._name = "subscriptions_batch_response_public_status"
  self._client = client
...
function SubscriptionsBatchResponsePublicStatusEntity:get_name()
  return self._name
end


function SubscriptionsBatchResponsePublicStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionsBatchResponsePublicStatusEntity.new(self._client, opts)
end
...
function SubscriptionsBatchResponsePublicStatusEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionsBatchResponsePublicStatusEntity:deleted()
  return true == self._deleted
end


function SubscriptionsBatchResponsePublicStatusEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionsBatchResponsePublicStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionsBatchResponsePublicStatusEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionsBatchResponsePublicStatusEntity:match_get()
...
function SubscriptionsBatchResponsePublicStatusEntity:stream(action, args, callopts)
...
---@param reqdata SubscriptionsBatchResponsePublicStatusCreateData
---@param ctrl? table
---@return SubscriptionsBatchResponsePublicStatus
---@return string? err
function SubscriptionsBatchResponsePublicStatusEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function SubscriptionsBatchResponsePublicStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionsBatchResponsePublicStatusEntity

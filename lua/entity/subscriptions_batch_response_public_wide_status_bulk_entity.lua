-- HubspotCommunicationPreferences SDK SubscriptionsBatchResponsePublicWideStatusBulk entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SubscriptionsBatchResponsePublicWideStatusBulkEntity = {}
SubscriptionsBatchResponsePublicWideStatusBulkEntity.__index = SubscriptionsBatchResponsePublicWideStatusBulkEntity


function SubscriptionsBatchResponsePublicWideStatusBulkEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionsBatchResponsePublicWideStatusBulkEntity)
  self._name = "subscriptions_batch_response_public_wide_status_bulk"
  self._client = client
...
function SubscriptionsBatchResponsePublicWideStatusBulkEntity:get_name()
  return self._name
end


function SubscriptionsBatchResponsePublicWideStatusBulkEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionsBatchResponsePublicWideStatusBulkEntity.new(self._client, opts)
end
...
function SubscriptionsBatchResponsePublicWideStatusBulkEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionsBatchResponsePublicWideStatusBulkEntity:deleted()
  return true == self._deleted
end


function SubscriptionsBatchResponsePublicWideStatusBulkEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionsBatchResponsePublicWideStatusBulkEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionsBatchResponsePublicWideStatusBulkEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionsBatchResponsePublicWideStatusBulkEntity:match_get()
...
function SubscriptionsBatchResponsePublicWideStatusBulkEntity:stream(action, args, callopts)
...
---@param reqdata SubscriptionsBatchResponsePublicWideStatusBulkCreateData
---@param ctrl? table
---@return SubscriptionsBatchResponsePublicWideStatusBulk
---@return string? err
function SubscriptionsBatchResponsePublicWideStatusBulkEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function SubscriptionsBatchResponsePublicWideStatusBulkEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionsBatchResponsePublicWideStatusBulkEntity

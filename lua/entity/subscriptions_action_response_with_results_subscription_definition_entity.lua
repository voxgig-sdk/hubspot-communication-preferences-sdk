-- HubspotCommunicationPreferences SDK SubscriptionsActionResponseWithResultsSubscriptionDefinition entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity = {}
SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity.__index = SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity


function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity)
  self._name = "subscriptions_action_response_with_results_subscription_definition"
  self._client = client
...
function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:get_name()
  return self._name
end


function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity.new(self._client, opts)
end
...
function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:deleted()
  return true == self._deleted
end


function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:match_get()
...
function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:stream(action, args, callopts)
...
---@param reqmatch SubscriptionsActionResponseWithResultsSubscriptionDefinitionListMatch
---@param ctrl? table
---@return SubscriptionsActionResponseWithResultsSubscriptionDefinition[]
---@return string? err
function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionsActionResponseWithResultsSubscriptionDefinitionEntity

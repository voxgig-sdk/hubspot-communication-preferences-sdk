-- HubspotCommunicationPreferences SDK SubscriptionsBatchResponsePublicStatusBulk entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SubscriptionsBatchResponsePublicStatusBulkEntity = {}
SubscriptionsBatchResponsePublicStatusBulkEntity.__index = SubscriptionsBatchResponsePublicStatusBulkEntity


function SubscriptionsBatchResponsePublicStatusBulkEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionsBatchResponsePublicStatusBulkEntity)
  self._name = "subscriptions_batch_response_public_status_bulk"
  self._client = client
...
function SubscriptionsBatchResponsePublicStatusBulkEntity:get_name()
  return self._name
end


function SubscriptionsBatchResponsePublicStatusBulkEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionsBatchResponsePublicStatusBulkEntity.new(self._client, opts)
end
...
function SubscriptionsBatchResponsePublicStatusBulkEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionsBatchResponsePublicStatusBulkEntity:deleted()
  return true == self._deleted
end


function SubscriptionsBatchResponsePublicStatusBulkEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionsBatchResponsePublicStatusBulkEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionsBatchResponsePublicStatusBulkEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionsBatchResponsePublicStatusBulkEntity:match_get()
...
function SubscriptionsBatchResponsePublicStatusBulkEntity:stream(action, args, callopts)
...
---@param reqdata SubscriptionsBatchResponsePublicStatusBulkCreateData
---@param ctrl? table
---@return SubscriptionsBatchResponsePublicStatusBulk
---@return string? err
function SubscriptionsBatchResponsePublicStatusBulkEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function SubscriptionsBatchResponsePublicStatusBulkEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionsBatchResponsePublicStatusBulkEntity

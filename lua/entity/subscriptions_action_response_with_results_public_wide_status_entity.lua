-- HubspotCommunicationPreferences SDK SubscriptionsActionResponseWithResultsPublicWideStatus entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SubscriptionsActionResponseWithResultsPublicWideStatusEntity = {}
SubscriptionsActionResponseWithResultsPublicWideStatusEntity.__index = SubscriptionsActionResponseWithResultsPublicWideStatusEntity


function SubscriptionsActionResponseWithResultsPublicWideStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionsActionResponseWithResultsPublicWideStatusEntity)
  self._name = "subscriptions_action_response_with_results_public_wide_status"
  self._client = client
...
function SubscriptionsActionResponseWithResultsPublicWideStatusEntity:get_name()
  return self._name
end


function SubscriptionsActionResponseWithResultsPublicWideStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionsActionResponseWithResultsPublicWideStatusEntity.new(self._client, opts)
end
...
function SubscriptionsActionResponseWithResultsPublicWideStatusEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionsActionResponseWithResultsPublicWideStatusEntity:deleted()
  return true == self._deleted
end


function SubscriptionsActionResponseWithResultsPublicWideStatusEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionsActionResponseWithResultsPublicWideStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionsActionResponseWithResultsPublicWideStatusEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionsActionResponseWithResultsPublicWideStatusEntity:match_get()
...
function SubscriptionsActionResponseWithResultsPublicWideStatusEntity:stream(action, args, callopts)
...
---@param reqmatch SubscriptionsActionResponseWithResultsPublicWideStatusListMatch
---@param ctrl? table
---@return SubscriptionsActionResponseWithResultsPublicWideStatus[]
---@return string? err
function SubscriptionsActionResponseWithResultsPublicWideStatusEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function SubscriptionsActionResponseWithResultsPublicWideStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionsActionResponseWithResultsPublicWideStatusEntity

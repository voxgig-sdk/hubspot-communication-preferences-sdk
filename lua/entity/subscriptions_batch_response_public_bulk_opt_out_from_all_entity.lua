-- HubspotCommunicationPreferences SDK SubscriptionsBatchResponsePublicBulkOptOutFromAll entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity = {}
SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity.__index = SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity


function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity)
  self._name = "subscriptions_batch_response_public_bulk_opt_out_from_all"
  self._client = client
...
function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:get_name()
  return self._name
end


function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity.new(self._client, opts)
end
...
function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:deleted()
  return true == self._deleted
end


function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:match_get()
...
function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:stream(action, args, callopts)
...
---@param reqdata SubscriptionsBatchResponsePublicBulkOptOutFromAllCreateData
---@param ctrl? table
---@return SubscriptionsBatchResponsePublicBulkOptOutFromAll
---@return string? err
function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionsBatchResponsePublicBulkOptOutFromAllEntity
